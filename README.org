...
=orgmine= requires at least:
- GNU Emacs >= 25.1
- Org-mode >= 9.0

Note: While Emacs 25.1 is the minimum, please ensure Org-mode is updated to 9.0+
if you are using the version bundled with Emacs 25, which defaults to Org 8.2.10.
